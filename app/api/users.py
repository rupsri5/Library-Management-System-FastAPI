...
@user_routes.post("/students", response_model=StudentIDResponse, status_code=201, response_model_by_alias=False)
def create_student(user: Student):
    try:
        ...
        existing_student = collection_st.find_one({"name": user.name})
...
@user_routes.get("/students", response_model=list[Student], status_code=200)
...
@user_routes.get("/students/{student_id}", response_model=Student, response_model_by_alias=False, status_code=200)
...
@user_routes.patch("/students/{student_id}", status_code=204)
...
@user_routes.delete("/students/{student_id}", status_code=200)
